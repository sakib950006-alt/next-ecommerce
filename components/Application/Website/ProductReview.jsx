...
form.reset()
    ...
    queryClint.invalidateQueries(['product-review'])
  ...
  return (
    <div className='shadow rounded border-b mb-20'>
      <div className='p-3 bg-gray-50'>
        <h2 className='font-semibold text-2xl'>Reting & Reviews</h2>
      </div>
      <div className='p-5'>
        <div className='flex justify-between flex-wrap items-center '>
          ...
          <div className='md:w-1/2 w-full md:text-end text-center'>
            <Button onClick={()=> setIsReview(!isReview)} type="button" variant="outline" className='md:w-fit w-full py-6 px-10 cursor-pointer'>
              Write Review
            </Button>
          </div>
