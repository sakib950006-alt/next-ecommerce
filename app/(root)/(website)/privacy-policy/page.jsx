    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20'>
                ...
                <p>
                    At E-store, we are committed to protecting your privacy and ensuring that your
                ...
                <ul className='list-disc ps-10 mt-3'>
                    <li><b>Personal Information:</b> Such as your name, email address, phone number, and
                     shipping/billing addresses, provided during account registration or checkout.</li>
                    <li><b>Payment Details:</b> Collected securely through encrypted payment gateways.</li>
                    <li><b>Usage Data:</b> Including your browser type, IP address, pages visited,
                     and time spent on the site to help us improve user experience.</li>
                </ul>
                ...
                <ul className='list-disc ps-10 mt-3'>
                    ...
                    <li>To send order updates, promotional offers, and newsletters (you may opt 
                        out at any time).</li>
                ...
                <p className='mt-5'>
                    ...
                    except when necessary to fulfill your order or comply with legal obligations.
                </p>

                <p className='mt-3'>
                    By using our website, you consent to the practices outlined in this Privacy Policy.
                     We may update this policy from time to time, and any changes will be reflected on this
                      page.
                </p>
