 ...
 if (authStore) {
  ...
  const placeOrder = async (formdata) => {
    ...
    try {
      ...
      const razOption = {
        ...
        "image": "http://localhost:3000/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-black.b2308bc3.png&w=384&q=75",
        ...
        "handler": async function (response) {
          ...
          if (paymentResponseData.success) {
            toast.success(paymentResponseData.message)
            dispatch(clearCart())
            orderForm.reset()
            ...
            toast.error(paymentResponseData.message)
            setOrderConfirmation(false)
          }
  ...
  return (
    <div>
      ...
      {orderConfirmation && <div className='h-screen w-screen fixed top-0 left-0 z-50 bg-black/10 '>
            ...
            <div className='mt-5'>
              <Form {...orderForm}>
                <form className='grid grid-cols-2 gap-5 ' onSubmit={orderForm.handleSubmit(placeOrder)}>
                  ...
                  <div className='mb-3'>
                    <ButtonLoading type="submit" loading={placingOrder} text="Place Order" className="bg-black rounded-full px-5 cursor-pointer" />
                  </div>
                </form>
              </Form>
